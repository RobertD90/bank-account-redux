...
const App = () => {
  ...
  const handleDeposit = () => {
    dispatch(deposit({ amount: Number(withdrawalAmount) })); // Dispatch deposit action with the entered deposit amount
  ...
  const handleWithdrawal = () => {
    // ***TODO***
    dispatch(transfer(/**PAYLOAD */  { name: transferName, amount: Number(transferAmount) }))
